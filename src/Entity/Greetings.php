...
use Drupal\greetings\GreetingsInterface;
 ...
 * @ContentEntityType(
 *   id = "greetings",
 *   label = @Translation("Greetings entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\greetings\Entity\Controller\GreetingsListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\greetings\Form\GreetingsForm",
 *       "edit" = "Drupal\greetings\Form\GreetingsForm",
 ...
 * Example: 'entity.greetings.canonical'
 *
 * See routing file above for the corresponding implementation
 *
 * The 'Greetings' class defines methods and fields for the greetings entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see GreetingsInterface) also exposes the EntityOwnerInterface.
 ...
 * field.
 */
class Greetings extends ContentEntityBase implements GreetingsInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['greeting'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Greeting message'))
      ->setDescription(t('The greeting message of the Greetings entity.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['langcode'] = BaseFieldDefinition::create('language')
      ...
      ->setDescription(t('The language code of Greetings entity.'));
